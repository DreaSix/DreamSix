  ...
  return (
    <div>
      ...
      <div className="players-final-list">
        ...
        <div className="match-name-container">Match Name: {matchData?.teamOneName} vs {matchData?.teamTwoName}</div>
          ...
          <div className="players-column">
            {playersTeam1?.map((player, index) => (
              <div className="player-card" key={index}>
                ...
                ></div> */}
                  <img src={`data:image/jpeg;base64,${player.playerImage}`} className="match-banner" />
                  <div className="details">
                    <div className="player-amount">₹{player.amount ? player.amount : 0}</div>
